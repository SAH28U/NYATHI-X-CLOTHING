...
function setupEventListeners() {
    ...
    // The previous proceedToCheckout event listener is now handled directly
    // by the specific click listener for #checkout-btn in DOMContentLoaded.
}
...
function animateElement(element, animation, delay = 0, callback = null) {
    setTimeout(() => {
        if (element) { // Check if element exists before animating
